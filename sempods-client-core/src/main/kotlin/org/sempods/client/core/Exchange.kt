...
/**
 * Every status an answer can carry, for an operation that classifies none: a foreign target's contract
 * is not this library's to know. OkHttp reads any three digits, so a set ending at 599 would still refuse
 * one.
 */
