...
| Consent page submitted with nothing selected, or through its "Remove access" button, by an app that holds something | `app disconnected` — the grants are deleted, the refresh families revoked and an installation or management authority withdrawn. The denial is real; it also has an effect |
