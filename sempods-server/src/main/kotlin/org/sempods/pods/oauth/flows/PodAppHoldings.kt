 ...
 *
 * Its grants, and a management authority that still stands: one approved on its own writes no grant,
 * and a disconnect is what withdraws it before its hour is up.
 */
