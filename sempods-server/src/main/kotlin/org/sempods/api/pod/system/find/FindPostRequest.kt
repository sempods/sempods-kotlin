 ...
 * the shape reserved in `docs/concepts/graph-retrieval.md`. All fields optional / nullable; the
 * same [FindRequestParser] validation applies (absent/blank `text` → 400).
 *
