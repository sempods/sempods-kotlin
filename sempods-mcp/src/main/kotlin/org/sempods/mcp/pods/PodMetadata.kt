...
data class PodOAuthMetadata(
  ...
  val jwksUri: String?,
  /**
   * What the pod says a client may put in `scope` — the union of `scopes_supported` in its
   * protected-resource metadata (RFC 9728 §2) and its AS metadata (RFC 8414 §2), empty for a pod
